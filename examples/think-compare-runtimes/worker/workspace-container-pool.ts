...
import { type IWorkspaceContainerAPI, withWorkspaceContainer } from "@cloudflare/workspace";
...
class WorkspaceContainerHostBase extends DurableObject<WorkspacePoolEnv> {
...
export class WorkspaceContainerHost extends withWorkspaceContainer(WorkspaceContainerHostBase) {}
