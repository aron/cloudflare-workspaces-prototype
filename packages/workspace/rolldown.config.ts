// Bundle @cloudflare/workspace's source plus its internal deps
// (@cloudflare/dofs, @cloudflare/workspace-rpc) into a single ESM
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@cloudflare/workspace-rpc": resolve(here, "../rpc/src/index.ts"),
      "@cloudflare/workspace-rpc/driver": resolve(here, "../rpc/src/sync-driver.ts"),
    },
  },
  // ESM only. Nothing in-tree loads CJS — the example Worker, wsd,
