...
// packages/wsd/package.json (the source of truth), copy the binary
// into packages/wsd-linux-x64/bin/, and npm publish.
//
// Run manually for now:
//   npm run publish:linux-x64 --workspace @cloudflare/workspace-wsd
//
...
console.log("[publish-linux-x64] building wsd-linux-x64");
...
console.log(`[publish-linux-x64] publishing @cloudflare/workspace-wsd-linux-x64@${version}`);
