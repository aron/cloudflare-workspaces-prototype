/**
 * RoomDO — Phase 3 spec, driven by tests.
 *
 * Lifecycle:
 *   1. AppDO mints a room id and POSTs /init to the RoomDO.
...
let roomCounter = 0;
function freshRoom() {
  // Each test addresses a unique RoomDO instance so state doesn't bleed.
  roomCounter += 1;
...
describe("RoomDO @mention → thread", () => {
