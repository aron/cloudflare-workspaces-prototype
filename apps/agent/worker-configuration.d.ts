/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 611bc505c5a14733a6ede1b11c51f631)
// Runtime types generated with workerd@1.20260801.1 2026-05-01 enable_abortsignal_rpc,nodejs_compat
interface __BaseEnv_Env {
	...
	Agent: DurableObjectNamespace<import("./src/index").Agent>;
	SubAgent: DurableObjectNamespace<import("./src/index").SubAgent>;
	App: DurableObjectNamespace<import("./src/index").App>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "Agent" | "Sandbox" | "WarmPool" | "SubAgent" | "App" | "Room";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SANDBOX_TRANSPORT" | "WARM_POOL_TARGET" | "WARM_POOL_REFRESH_INTERVAL" | "OPENAI_MODEL">> {}
}
