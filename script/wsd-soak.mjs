...
// wsd-soak.mjs — soak test for the wsd sync loop.
//
// Boots two wsd containers wired as peer-to-peer:
//   A: standalone wsd, port mapped to the host.
//   B: standalone wsd, port mapped to the host AND
...
// Knobs (env vars):
//
//   WSD_BINARY        path to wsd-linux-x64 binary
